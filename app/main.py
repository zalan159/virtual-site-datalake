...
from app.routers import auth, files, tasks, attachments, metadata, scene, public_models, streams, payments
...
MONGO_CONFIG = {"db_name": os.getenv("MONGO_DB_NAME")}
...
app = FastAPI(title="灵境孪生中台", description="支持用户认证的GLTF文件存储系统API", version="1.0.0")
...
app.include_router(payments.router, prefix="/payments", tags=["充值"])
